...
return [
    ...
    */
    ...
    'cloud_name' => env('CLOUDINARY_CLOUD_NAME', 'dqkdtkjur'),
    'api_key' => env('CLOUDINARY_API_KEY', '849177453975115'),
    'api_secret' => env('CLOUDINARY_API_SECRET', '8DNjN-TLxR3efGygfSPE_CW6hE0'),
